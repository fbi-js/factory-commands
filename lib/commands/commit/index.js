...
const commit_json_1 = __importDefault(require("./configs/commit.json"));
const release_json_1 = __importDefault(require("./configs/release.json"));
...
class CommandCommit extends fbi_1.Command {
    ...
    async bumpVersion(pkg) {
        ...
        if (!oldVersion) {
            await standard_version_1.default(Object.assign(Object.assign({}, release_json_1.default), { firstRelease: true }));
        ...
        const opts = Object.assign(Object.assign({}, release_json_1.default), { dryRun: true });
        const recommendedVersion = await bump(Object.assign(Object.assign({}, opts), (prerelease ? { prerelease } : {})), oldVersion);
        const bumps = [];
        for (const tag of tagNames) {
            for (const type of releaseTypes) {
                bumps.push(await bump(tag
                    ? Object.assign(Object.assign({}, opts), { releaseAs: type, prerelease: tag }) : Object.assign(Object.assign({}, opts), { releaseAs: type }), oldVersion).then((newVersion) => ({
                    name: `${type} ${tag}`,
                    message: newVersion,
                    hint: `${type} ${tag}`
                })));
        ...
        const options = Object.assign(Object.assign(Object.assign({}, release_json_1.default), (results[0] ? { releaseAs: results[0] } : {})), (results[1] ? { prerelease: results[1] } : {}));
